...
export function SessionArtifactManager({ open, artifacts, onClose, onChanged }: Props) {
  ...
  return (
    <aside
      className="agenthub-artifact-dock flex min-h-0 shrink-0 flex-col overflow-hidden border-l"
      role="complementary"
      aria-label="会话文件与产物"
    >
      ...
      <div className="grid min-h-0 flex-1 overflow-hidden lg:grid-cols-[188px_minmax(0,1fr)]">
