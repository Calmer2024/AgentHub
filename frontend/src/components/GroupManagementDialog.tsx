...
import { Loader2, MessageCircleMore, Save, UserRoundMinus, UserRoundPlus, X } from "lucide-react";
...
export function GroupManagementDialog({
  ...
  return (
    <div className="agenthub-backdrop fixed inset-0 z-[1400] flex items-center justify-center px-4">
      <div className="agenthub-modal agenthub-modal-pop flex max-h-[86dvh] w-full max-w-xl flex-col overflow-hidden rounded-3xl border">
        <div className="agenthub-header flex items-center justify-between gap-3 border-b px-5 py-4">
          <div className="flex min-w-0 items-center gap-3">
            <AgentAvatar kind="group" name={session.title} size="md" />
            <div className="min-w-0">
              <h2 className="agenthub-strong truncate text-base font-semibold">群管理</h2>
              <p className="agenthub-muted mt-0.5 truncate text-xs">{members.length} 个成员</p>
            </div>
          </div>
          <button
            type="button"
