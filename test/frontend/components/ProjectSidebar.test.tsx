...
import { ProjectSidebar } from "../../../frontend/src/components/ProjectSidebar";
import type { AgentConfig, Project } from "../../../frontend/src/types";
...
vi.mock("../../../frontend/src/api/client", () => workspaceApiMocks);
