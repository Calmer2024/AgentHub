...
**版本**: v2.0
**创建日期**: 2026-05-27
**更新日期**: 2026-05-28 — 模块化拆解
**状态**: Draft
**关联 ADR**: ADR-0004, ADR-0005, ADR-0007, **[ADR-0008 (Orchestrator 架构)](../adr/0008-orchestrator-architecture.md)**

> **Phase 3 已拆解为 8 个渐进模块。** 本文件保留完整技术规格作为权威参考。
> 开发和任务分配请使用模块化文档: **[Phase 3 模块总览](phase3-modules.md)** + 各 `phase3.x-*-spec.md`。
> 团队协作请参阅: **[Phase 3 并行开发指南](phase3-parallel-guide.md)**。

## 模块索引

| 模块 | Spec | 状态 | 可并行 |
|------|------|------|--------|
| M1: 基础设施 | [phase3.1-infrastructure-spec](phase3.1-infrastructure-spec.md) | ✅ DONE | - |
| M2: 消息操作 | [phase3.2-message-actions-spec](phase3.2-message-actions-spec.md) | Draft | ✅ M3 |
| M3: 消息搜索 | [phase3.3-message-search-spec](phase3.3-message-search-spec.md) | Draft | ✅ M2 |
| M4: Orchestrator 核心 | [phase3.4-orchestrator-core-spec](phase3.4-orchestrator-core-spec.md) + **[ADR-0008](../adr/0008-orchestrator-architecture.md)** | Draft | - |
| M5: 链式协作 | [phase3.5-chain-collab-spec](phase3.5-chain-collab-spec.md) | Draft | ✅ M6 |
| M6: 产物版本+Diff | [phase3.6-artifact-versioning-spec](phase3.6-artifact-versioning-spec.md) | Draft | ✅ M4 |
| M7: 产物在线编辑 | [phase3.7-artifact-editing-spec](phase3.7-artifact-editing-spec.md) | Draft | - |
| M8: Store拆分+收尾 | [phase3.8-integration-spec](phase3.8-integration-spec.md) | Draft | - |
