...
├── phase7/                      ← Phase 7: 任务可控性 + 审批 + 环境体检 + IM 体验 + 演示闭环 + 上下文缓存策略 🚧
└── planning/                    ← 历史规划文档（参考）
```
...
| [Phase 7](phase7/) | 任务可控性 + 审批 + 环境体检 + IM 体验 + 演示闭环 | 🚧 | v1.0 本机 MVP 基线已覆盖运行控制、审批、体检、IM 会话基线和 UI 加固；7E 上下文包与缓存策略已记录；真实 cc 完整自动化演示脚本待补 |
