...
> 如果要了解“为什么做这个决策”，请读 `docs/adr/`；如果要了解“现在系统实际是什么样”，请读本目录。
...
| [documentation-governance.md](documentation-governance.md) | ADR、PRD、Architecture、Archive 等文档边界和更新规则 |
...
- 判断某类信息应该写到哪里：读 `documentation-governance.md`。
