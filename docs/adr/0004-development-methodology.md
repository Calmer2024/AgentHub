...
1. **架构按需生长**：Day 1 不建全部七层。每轮增量只在复杂度真正上升时引入新层/新模块。
...
Phase 0 ─── Phase 1 ─── Phase 2 ─── Phase 3 ─── Phase 4
 准备期      行走骨架    核心功能     增强功能     收尾打磨
 (2-3天)     (3-5天)     (1-2周)      (1-2周)      (3-5天)

产出:        产出:        产出:         产出:         产出:
 接口契约     单聊全链路   多Agent       P1功能        Bug修复
 目标架构图   流式对话     群聊+编排     产物丰富       Demo视频
 骨架定义     可运行Demo   产物内联      部署发布       答辩准备
 优先级矩阵               可演示切片    多端适配
```
