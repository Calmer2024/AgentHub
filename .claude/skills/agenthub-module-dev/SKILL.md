...
- 引用仍有效：`docs/specs/`、`docs/TEST_PROTOCOL.md`、`docs/testing/UX_TEST_SPEC.md`、`docs/GIT_PROTOCOL.md`、`CLAUDE.md` 均存在。
...
- 引用仍有效：`docs/specs/phase9/README.md`、`docs/TEST_PROTOCOL.md`、`docs/GIT_PROTOCOL.md`、`CLAUDE.md` 均存在。
